...
public class ForbiddenResearch
{
	...
	public static void addInfernalism()
	{
		...
		(new DarkResearchItem("HELLFIRE", "FORBIDDEN", (new AspectList()).add(Aspect.FIRE, 3).add(DarkAspects.NETHER, 4).add(Aspect.TRAVEL, 2), -5, 2, 1, new ItemStack(Block.fire))).setPages(new ResearchPage[] {new ResearchPage("forbidden.research_page.HELLFIRE.1")}).setRound().registerResearchItem();
