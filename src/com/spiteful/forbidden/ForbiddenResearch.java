...
public class ForbiddenResearch
{
	...
	public static void addInfernalism()
	{
		...
		(new DarkResearchItem("RIDINGCROP", "FORBIDDEN", new AspectList(), -8, -1, 0, new ItemStack(ForbiddenItems.ridingCrop))).setPages(new ResearchPage[] {new ResearchPage("forbidden.research_page.RIDINGCROP.1"), new ResearchPage((IRecipe)recipes.get("RidingCrop"))}).setStub().setAutoUnlock().registerResearchItem();
